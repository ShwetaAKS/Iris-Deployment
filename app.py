...
st.set_page_config(page_title='Iris Project Shweta',layout='wide')

#Show the title of app in the body
st.title('Iris Project - Shweta Kolapkar')
...
if button:
    #Load preprocessor
    with open('/workspaces/Iris-Deployment/notebook/model.pkl','rb') as file1:
        model = pickle.load(file1)
    #Load the model
    with open('/workspaces/Iris-Deployment/notebook/pre.pkl','rb') as file2:
